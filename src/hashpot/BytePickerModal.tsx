        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              maxHeight: '90vh',
              overflowY: 'auto',
              background: 'linear-gradient(180deg, #0c0c1e 0%, #06060f 100%)',
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  style={{ width: 32, height: 32, background: '#0a0a1e', borderColor: '#1e2048', cursor: 'pointer', color: '#a0a8c8' }}
                >
                  <X size={16} />
                </button>
              </div>
            ...
            {/* Column headers */}
            <div style={{ display: 'grid', gridTemplateColumns: '20px repeat(16, 1fr)', gap: 2, marginBottom: 2 }}>
              <div />
              {NIB.map((label) => (
                <div
                  key={`col-${label}`}
                  className="font-mono font-bold"
                  style={{ textAlign: 'center', fontSize: '0.6rem', color: '#6872a0', lineHeight: '14px' }}
                >
                  {label}
                </div>
              ))}
            ...
            {Array.from({ length: 16 }).map((_, row) => (
              <div key={row} style={{ display: 'grid', gridTemplateColumns: '20px repeat(16, 1fr)', gap: 2, marginBottom: 2 }}>
                <div
                  className="font-mono font-bold flex items-center justify-center"
                  style={{ fontSize: '0.6rem', color: '#6872a0' }}
                >
                  {NIB[row]}
                </div>
                ...
                {Array.from({ length: 16 }).map((_, col) => {
                  ...
                  return (
                    <motion.button
                      ...
                      disabled={disabled}
                      whileHover={!disabled ? { scale: 1.2, zIndex: 10 } : undefined}
