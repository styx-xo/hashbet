...
export function SlotInfoPanel({ selectedSlot, slotPools, totalPool, userBet, phase, winnerSlot, btcPrice }: Props) {
  ...
  const multiplier = pool > 0 ? (totalPool * 0.99) / pool : 0;
        ...
        <div style={{ padding: '20px 24px' }}>
          ...
          <div className="flex gap-6 flex-wrap">
            <div>
              ...
              <div className="font-mono font-bold" style={{ color: '#e8eeff', fontSize: '1rem' }}>
                {fmtBtc(pool)} BTC
              </div>
              {btcPrice && pool > 0 && (
            ...
            <div>
              ...
              <div
                className="font-display font-black"
                style={{ fontSize: '1.2rem', color: pool > 0 ? color : '#3a4060' }}
              >
            ...
            {userBetOnThis && potentialWin > 0 && (
              <div>
                ...
                <div className="font-mono font-bold" style={{ color, fontSize: '1rem' }}>
